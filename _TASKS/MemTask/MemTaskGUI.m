function varargout = MemTaskGUI(varargin)
% MEMTASKGUI MATLAB code for MemTaskGUI.fig
%      MEMTASKGUI, by itself, creates a new MEMTASKGUI or raises the existing
%      singleton*.
%
%      H = MEMTASKGUI returns the handle to a new MEMTASKGUI or the handle to
%      the existing singleton*.
%
%      MEMTASKGUI('CALLBACK',hObject,eventData,handles,...) calls the local
%      function named CALLBACK in MEMTASKGUI.M with the given input arguments.
%
%      MEMTASKGUI('Property','Value',...) creates a new MEMTASKGUI or raises the
%      existing singleton*.  Starting from the left, property value pairs are
%      applied to the GUI before MemTaskGUI_OpeningFcn gets called.  An
%      unrecognized property name or invalid value makes property application
%      stop.  All inputs are passed to MemTaskGUI_OpeningFcn via varargin.
%
...
% Edit the above text to modify the response to help MemTaskGUI

% Last Modified by GUIDE v2.5 13-Jun-2019 12:34:31

% Begin initialization code - DO NOT EDIT
gui_Singleton = 1;
gui_State = struct('gui_Name',       mfilename, ...
                   'gui_Singleton',  gui_Singleton, ...
                   'gui_OpeningFcn', @MemTaskGUI_OpeningFcn, ...
                   'gui_OutputFcn',  @MemTaskGUI_OutputFcn, ...
                   'gui_LayoutFcn',  [] , ...
                   'gui_Callback',   []);
...
% --- Executes just before MemTaskGUI is made visible.
function MemTaskGUI_OpeningFcn(hObject, eventdata, handles, varargin)
% This function has no output args, see OutputFcn.
% hObject    handle to figure
% eventdata  reserved - to be defined in a future version of MATLAB
% handles    structure with handles and user data (see GUIDATA)
% varargin   command line arguments to MemTaskGUI (see VARARGIN)

% Choose default command line output for MemTaskGUI
...
% UIWAIT makes MemTaskGUI wait for user response (see UIRESUME)
% uiwait(handles.figure1);


% --- Outputs from this function are returned to the command line.
function varargout = MemTaskGUI_OutputFcn(hObject, eventdata, handles) 
...
% colors = str2double(get(handles.colors, 'string'));
...
%         set(handles.colors, 'string',colors);
